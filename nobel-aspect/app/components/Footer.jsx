...
const Footer = ({ noDesign }) => {
  return (
    <>
      <footer className={`relative p-4 ${noDesign ? "bg-white" : "bg-sitePrimary-100"} md:p-8 lg:p-10 dark:bg-gray-800`}>
        {!noDesign && (
          <div className="absolute w-full h-full -m-4 md:-m-8 lg:-m-10">
            <Image
              src={"/Footer_Design.svg"}
              alt=""
              width={1400}
              height={200}
        ...
        <div className="mx-auto max-w-screen-xl text-center relative z-10">
          <a
            href="/"
            className="flex justify-center items-center text-2xl font-semibold text-gray-900 pb-5"
          >
            <Logo wordmark />
          </a>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 1234 noble aspect All rights reserved.
            </span>
            <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
              <a
                href="https://x.com"
                className="text-gray-500 hover:text-sitePrimary-700"
              >

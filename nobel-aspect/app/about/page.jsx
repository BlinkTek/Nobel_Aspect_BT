          ...
          <div className="space-y-8 md:space-y-0">
            <section className="bg-white dark:bg-gray-900">
              <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl md:flex sm:py-16 lg:px-6">
                <img className="w-full md:w-[52%] dark:hidden" src="/about_1.png" alt="dashboard image" />
            ...
            <section className="bg-white dark:bg-gray-900">
              <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl md:flex sm:py-16 lg:px-6">
                <img className="w-full md:w-[52%] dark:hidden order-2" src="/about_2.png" alt="dashboard image" />
            ...
            <section className="bg-white dark:bg-gray-900">
              <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl md:flex sm:py-16 lg:px-6">
                <img className="w-full md:w-[52%] dark:hidden" src="/about_3.png" alt="dashboard image" />
                <div className="mt-4 md:mt-0">
                  <h2 className="mb-4 text-xl md:text-2xl lg:text-3xl font-medium text-siteTextIcon-primary dark:text-white uppercase">
                    OUR MISSION
                  </h2>

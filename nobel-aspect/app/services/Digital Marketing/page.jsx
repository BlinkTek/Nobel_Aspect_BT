...
const DigitalMarketing = () => {
  const [serviceData, setServiceData] = useState([
    {
      icon: "",
      content: `Unlock the full potential of your brand with our expert digital marketing services. We develop targeted strategies that drive visibility and engagement across all digital platforms.`,
    },
    {
      icon: "",
      content: `Our data-driven approach ensures that your campaigns are not only creative but also highly effective in reaching your audience.`,
    },
    {
      icon: "",
      content: `From SEO and social media to content marketing and PPC, we tailor every strategy to meet your specific goals. Let us help you navigate the digital landscape with precision and creativity.`,
    },
    {
      icon: "",
      content: `Partner with us to transform your online presence and achieve measurable results. Our commitment to innovation and excellence will elevate your brand and maximize its impact in the digital world.`,
    },
  ]);
  return (
        ...
        <div className="max-w-screen-xl min-h-screen px-10 flex flex-col md:flex-row gap-10 lg:gap-24 items-center justify-center">
          <div className="w-full flex flex-col gap-5 order-2 md:order-none">
            ...
            <p className="text-base lg:text-lg text-siteTextIcon-disabled font-semibold">
              Discover the power of strategic digital marketing with Noble Aspect, LLC. We specialize in crafting custom
              strategies that elevate your brands online presence.
            </p>
          </div>

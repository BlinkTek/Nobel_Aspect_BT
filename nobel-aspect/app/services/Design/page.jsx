...
const Designing = () => {
  const [serviceData, setServiceData] = useState([
    {
      icon: "",
      content: `Transform your brand’s identity with our innovative design services. We combine artistic vision with strategic insight to create designs that resonate and captivate. From logo design to comprehensive brand visuals, our work ensures that your brand stands out with elegance and impact.`,
    },
    {
      icon: "",
      content: `<b>Tailored Creativity:</b> Every project is a fresh opportunity for us to bring your unique vision to life. Our team of skilled designers works closely with you to understand your goals and craft personalized solutions that reflect your brand’s essence, ensuring a cohesive and memorable visual identity.`,
    },
    {
      icon: "",
      content: `<b>Impactful Results:</b> Our designs are not just visually appealing; they’re engineered to engage and convert. By focusing on user experience and visual storytelling, we create designs that drive action and make a lasting impression, helping your brand connect more deeply with your audience.`,
    },
    {
      icon: "",
      content: `<b>End-to-End Solutions:</b> From concept to completion, we provide comprehensive design services that cover every aspect of your brand’s visual presence. Whether you need a new website, marketing materials, or a complete brand overhaul, we deliver high-quality, cohesive designs that elevate your brand’s presence and performance.`,
    },
  ]);
  return (
        ...
        <div className="max-w-screen-xl min-h-screen px-10 flex flex-col md:flex-row gap-10 lg:gap-24 items-center justify-center">
          <div className="w-full flex flex-col gap-5 order-2 md:order-none">
            ...
            <p className="text-base lg:text-lg text-siteTextIcon-disabled font-semibold">
              Elevate your brand’s visual identity with our cutting-edge design services. At Noble Aspect, LLC, we
              create captivating, user-centred designs that not only look stunning but also drive engagement.
            </p>
          </div>
